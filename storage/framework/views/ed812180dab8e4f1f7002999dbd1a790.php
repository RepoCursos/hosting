...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="<?php echo e(route('home')); ?>"><?php echo e(__('views.Home')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('product.index')); ?>"><?php echo e(__('views.Product')); ?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('category.index')); ?>"><?php echo e(__('views.Category')); ?></a>
                </li>
            </ul>
        </div>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <!-- enviamos el lenguaje seleccionado a la ruta de nuestro contolador -->
                            <li><a class="dropdown-item" href="<?php echo e(route('lang', $lang)); ?>"><?php echo e($language); ?></a></li>                           
                        <?php endif; ?>
...
<?php /**PATH /app/resources/views/layouts/_partials/menu.blade.php ENDPATH**/ ?>